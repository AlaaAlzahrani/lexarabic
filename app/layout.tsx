      ...
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          <div className="sm:flex sm:items-center sm:justify-between">
              <a href="http://localhost:3000/" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                  <Image src="/lexarabic_logo.svg" className="h-8" alt="شعار كَلِم" />
              ...
              <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                  <li>
                      <a href="/about" className="hover:text-[#8f5ecc] me-4 md:me-6">عن الموقع</a>
                  </li>
                  <li>
                      <a href="/privacy" className="hover:text-[#8f5ecc] me-4 md:me-6">الخصوصية</a>
                  </li>
                  <li>
                      <a href="/license" className="hover:text-[#8f5ecc] me-4 md:me-6">الترخيص</a>
                  </li>
                  <li>
                      <a href="/contact" className="hover:text-[#8f5ecc]">تواصل معنا</a>
                  </li>
              </ul>
          </div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
              <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">
                  © 2024 <a href="http://localhost:3000/" className="hover:text-[#8f5ecc]">كَلِم</a>. جميع الحقوق محفوظة.
              </span>
